...
def letter_guess():
    while True:
        ...
        if result in string.ascii_lowercase:
            return result
        else:
...
hangman_states = [hs_0, hs_1, hs_2, hs_3, hs_4, hs_5, hs_6, hs_7, hs_8, hs_9, hs_10]
...
while True:
    ...
    if lives_remaining > 0:
        ...
        if current_word_state == hangman_word:
            ...
            print("#################################################")
            print(f"Correct! The word was {hangman_word}. you guessed it in {guess_counter} guesses!")
            print(current_hangman_state)
            break
        else:

            #ask user if they want to solve or guess another letter
            print(f"The word is currently: {current_word_state} of length {len(hangman_word)}")
                    ...
                    if current_guess not in guessed_letters:
                        ...
                        if current_guess in hangman_word:
                            ...
                            for index in letter_indices:
                                current_word_state = current_word_state[:index] + hangman_word[index] + current_word_state[index+1:]
                        ...
                        #checks if the letter guessed is not in the word, updates hangman state and removes one from life counter
                            ...
                            print("#################################################")
                            print(f"Unfortunately, {current_guess} is not in the word.")
